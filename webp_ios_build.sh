...
declare -r SRCDIR=$DEPENDENCY_DIR/webp
declare -r TOPDIR=$BASE_BUILD_DIR
declare -r BUILDDIR="${TOPDIR}/build/webp"
declare -r TARGETDIR="${TOPDIR}/libs/WebP.framework"
...
declare -r PLATFORMS="iPhoneSimulator  iPhoneSimulator-64 iPhoneOS-V7 iPhoneOS-V7s iPhoneOS-V7-arm64"
